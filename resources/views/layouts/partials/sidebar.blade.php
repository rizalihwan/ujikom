    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if (auth()->user()->role == 'siswa')
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('siswa.index') }}"><i
                            data-feather="check-square"></i><span class="menu-title text-truncate"
                            data-i18n="Todo">Daftar Baru</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('pendaftar') }}"><i
                            data-feather="user"></i><span class="menu-title text-truncate"
                            data-i18n="Todo">Pendaftar</span></a>
                </li>
            @else
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('admin.index') }}"><i
                            ...
                            data-i18n="Todo">Data Siswa</span></a>
                </li>
            @endif
            <li class=" nav-item"><a class="d-flex align-items-center" href="javascript:void(0)" onclick="logout()"><i
                        data-feather="arrow-left"></i><span class="menu-title text-truncate"
                        data-i18n="Todo">Log Out</span></a>
            </li>
