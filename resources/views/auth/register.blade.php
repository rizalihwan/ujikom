                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="brand-text text-primary ml-1">PPDB</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">Register here! 👋</h2>
                                <p class="card-text mb-2">Isi field - field berikut untuk registrasi akun</p>
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            value="{{ old('name') }}" id="register-name" name="name"
                                            aria-describedby="register-name" tabindex="1" autofocus required />
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="username" class="form-control @error('username') is-invalid @enderror"
                                            value="{{ old('username') }}" id="login-username" name="username"
                                            placeholder="example" aria-describedby="login-username" tabindex="1" autofocus
                                            required />
                                        @error('username')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <p class="text-center mt-2"><span>Already have an account?</span><a
                                        href="{{ route('login') }}"><span>&nbsp;Sign In</span></a></p>
                            </div>
                        </div>
                        <!-- /Login-->
                    </div>
